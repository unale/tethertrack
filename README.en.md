...
> macOS · Turkish UI · free and open source (MIT)
>
...
- 🎯 **Real remaining quota:** enter the value from your carrier's app and VeriTakip decrements it as your computer spends
...
VeriTakip sends nothing to the internet. Measurements live only in `~/VeriTakip/` on your own machine. The phone's own usage (its apps, etc.) is not measured — only what this Mac spends over the hotspot.
