...
- 📱 **Hotspot Penceresi:** Ethernet kablosunu çekmeden, yalnızca ayrı bir tarayıcı penceresini telefon hattından açar — ve tek tıkla **Kapat (telefon verisini durdur)** ile proxy'yi ve o tarayıcı örneğini tamamen kapatır; böylece arka planda hiçbir şey kotayı eritmeye devam etmez
- 📶 **Hızlı telefon anahtarı:** Sistem Ayarları'na girmeden menüden telefonu (Wi-Fi) aç/kapat
